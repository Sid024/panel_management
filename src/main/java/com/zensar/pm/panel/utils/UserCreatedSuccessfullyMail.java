...
public class UserCreatedSuccessfullyMail {
    ...
    public void userCreatedSuccessfully(int userId,String name,String emailId, String password) {
        try {
            ...
            String message = "Hi " + name + ",\n\n" + "Your account has been successfully created on panel management.\n\n" 
            + "User name: " 
            + name + 
            "\nUser id: " + userId +
